...
6. ここまでのGTMの設定を反映し、index.htmlを開いた際にコンソールログで、SDKが初期化され、Braze Actionsタグで設定したイベントが発火することをご確認ください。
<img width="1209" height="822" alt="image" src="https://github.com/user-attachments/assets/e2ff47f4-f9ba-40e4-9329-fe592b660652" />


7. 上記が確認できたら、Brazeの管理画面内でキャンペーンのページを開き、アプリ内メッセージのキャンペーンを作成します。
   - 送信先：Webブラウザー
   - メッセージタイプ：カスタムコード
